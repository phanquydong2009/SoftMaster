...
import { Text, TouchableOpacity, View, Image, TextInput, FlatList, Dimensions, ScrollView } from 'react-native';
...
const HomeScreen = () => {
    ...
    const handleViewPopularCourses = () => {
        console.log("User ID truyền qua là:", userID);
        navigation.navigate('PopularCourses', { userID });
    };
